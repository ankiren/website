...
const PERSON_AGE = 30;
const PAGE_TITLE = "Beethoven Age 30 (1800)";
const PAGE_DESC = "Genius confronting deafness, creating revolutionary works";
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-2 mb-6">
          <div className="flex gap-2 overflow-x-auto">
            {tabs.map(tab => (
              <button key={tab.id} onClick={() => setActiveTab(tab.id as typeof activeTab)} className={`flex items-center gap-2 px-4 py-3 rounded-xl font-medium transition-all whitespace-nowrap ${activeTab === tab.id ? 'bg-amber-500 text-white' : 'text-gray-600 hover:bg-gray-100'}`}>
