...
const PERSON_AGE = 10;
const PAGE_TITLE = "Steve Jobs Age 10 (1965)";
const PAGE_DESC = "A curious child in Silicon Valley discovering electronics";
          ...
          <div className="flex gap-2 overflow-x-auto">
            {tabs.map(tab => (
              <button
                ...
                className={`flex items-center gap-2 px-4 py-3 rounded-xl font-medium transition-all whitespace-nowrap ${activeTab === tab.id ? 'bg-orange-500 text-white' : 'text-gray-600 hover:bg-gray-100'}`}
              >
