-- Initialize UAT environment for E2E tests
-- Usage: npx wrangler d1 execute ankiren-db-uat --remote --file=e2e/init-uat.sql

-- Create admin user if not exists
INSERT OR IGNORE INTO User (id, email, name, createdAt, updatedAt)
VALUES ('uat_admin_user', 'anhv.ict91@gmail.com', 'UAT Admin', datetime('now'), datetime('now'));
...
VALUES ('uat_admin_user', 'role_admin');
