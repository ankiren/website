...
|----|-------|-------------|
| AC-5.2.1 | View User Roles | View roles assigned to a user |
| AC-5.2.2 | Assign Role to User | Assign roles to users |
| AC-5.2.3 | Remove Role from User | Remove roles from users |
| AC-5.2.4 | Multiple Roles | Users can have multiple roles |
| AC-5.2.5 | First User Admin Assignment | First user is automatically Admin |
