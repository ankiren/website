...
|----|-------|-------------|
| AC-5.4.1 | API Access Control | API enforces permission checks |
| AC-5.4.2 | UI Access Control | Hide UI elements based on permissions |
| AC-5.4.3 | Page Access Control | Restrict page access by permissions |
| AC-5.4.4 | Feature Access Control | Control feature buttons by permissions |
| AC-5.4.5 | Current User Permissions | Get current user's permissions |
| AC-5.4.6 | Permission Caching | Permissions cached in JWT session |
