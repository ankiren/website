...
|----|-------|-------------|
| AC-5.1.1 | View Roles List | Admin can view all roles with details |
| AC-5.1.2 | Create New Role | Admin can create custom roles |
| AC-5.1.3 | Edit Role | Admin can edit role details |
| AC-5.1.4 | Delete Role | Admin can delete custom roles |
| AC-5.1.5 | Default System Roles | System has Admin and User roles by default |
