...
- [ ] "Continue with Google" button is visible on registration page
- [ ] Clicking the button redirects to Google OAuth consent screen
- [ ] User can authorize Ankiren to access their Google profile
- [ ] After authorization, user is redirected back to the app
- [ ] New users are automatically registered with their Google email
- [ ] Existing users (same email) are linked to their Google account
- [ ] User's name and profile picture are imported from Google (if available)
- [ ] Session is created after successful Google authentication
- [ ] User is redirected to dashboard after successful login
- [ ] Error message is shown if Google authentication fails
